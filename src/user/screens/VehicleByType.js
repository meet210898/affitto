...
import { getCompany, listVehicleByTypeDetails } from "../../actions/user/User";
...
export default function VehicleList() {
  ...
  React.useEffect(() => {
    ...
    dispatch(listVehicleByTypeDetails(typeId));
  }, [dispatch, typeId]);

  const vehicleByTypeDetails = useSelector(
    (state) => state.vehicleByTypeDetails
  );
  const { vehicleByType } = vehicleByTypeDetails;

  console.log(vehicleByType, "vehicleByType");
