        ...
        <Grid container>
          ...
          <Grid xs={6}>
            <Typography variant="h6" component="div">
              Vehicle Image:
              <ReactRoundedImage
                image={`${REACT_APP_HOST}/${editData && editData.vehicleImage}`}
                alt="vehicle"
                imageWidth="120"
                imageHeight="120"
                roundedSize="0"
          ...
          <Grid xs={6}>
            <Typography variant="h6" component="div">
              RC Image:
              <ReactRoundedImage
                image={`${REACT_APP_HOST}/${editData && editData.rcImage}`}
                alt="rcImage"
                imageWidth="120"
                imageHeight="120"
                roundedSize="0"
            ...
            <Typography variant="h6" component="div">
              PUC Image:
              <ReactRoundedImage
                image={`${REACT_APP_HOST}/${editData && editData.pucImage}`}
                alt="pucImage"
                imageWidth="120"
                imageHeight="120"
                roundedSize="0"
